...
<!-- 		<h1 class="page_title">在售作品</h1> -->
		<table class="cart_product">
			<tr class="bg">
				...
				<th class="name">状态</th>
				<th class="edit2" style="text-align: center">上架</th>
			</tr>
...
<%-- 						<a href="/product/${product.id}.html"> --%>
					...
					<td class="edit2">
					<button class="btn btn-primary btn-sm" onclick="location.href='/manager/production/online.action?productionID=${product.id}';">上架</button>
<%-- 					<a title="close" href="/manager/production/online.action?productionID=${product.id}">上架</a></td> --%>
