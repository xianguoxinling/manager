...
<%-- 						<a href="/product/${product.id}.html"> --%>
					...
					<td class="edit2">
					<button class="btn btn-primary btn-sm" onclick="location.href='/manager/production/offshelt.action?productionID=${product.id}';">下架</button>
<%-- 					<a title="close" href="/manager/production/offshelt.action?productionID=${product.id}">下架</a></td> --%>
