...
<link rel="shortcut icon" href="/images/favicon.ico" type="image/x-icon"/>
	...
	<script type="text/javascript" src="/js/classify.js"></script>
			...
			<script type="text/javascript">
				...
				$(function () {
					$.post("http://magic.puckart.com/manager/store/querywxinfo.action", function (data) {
						console.log(data);
						if(data.code == 10001){
							return;
						}
	...
	<div id="main">
		...
		<div id="content">
			...
			<div class="wrapper">
				<div class="aside">
					<ul class="nav001">
						<li><a href="/manager/store/addwxinfo.jsp" class="current">基本信息设置</a></li>
						<li>
...
<!-- 					<h2>添加微信基本信息</h2> -->
					...
					<div class="wrapper">
						<form id="addproduct" action="/manager/store/createwxinfo.action"
							...
							<input value="提交" type="submit" class="btn btn-default"
